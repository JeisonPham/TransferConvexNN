...
from NetDataLoader import NetDataset
...
# ]))
model = ARGS.model
train_dataset = NetDataset(model)
test_dataset = NetDataset(model, False)
...
if CVX_only==0:
    ...
    results_noncvx_sgd1 = sgd_solver_pytorch_v2(train_loader, test_loader, num_epochs1, num_neurons, beta, 
                            ...
                            num_classes=10, D_in=d, train_len=n, device=device)
